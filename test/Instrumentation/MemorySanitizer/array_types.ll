...
; CHECK-DAG: [[Sy:%.*]] = load i32, i32* inttoptr (i64 add (i64 ptrtoint ({{.*}}@__msan_param_tls to i64), i64 8) to i32*)
; CHECK-DAG: [[Sx:%.*]] = load i32, i32* inttoptr (i64 ptrtoint ({{.*}}@__msan_param_tls to i64) to i32*)
...
; CHECK-DAG: [[Sy:%.*]] = load i64, i64* inttoptr (i64 add (i64 ptrtoint ({{.*}}@__msan_param_tls to i64), i64 8) to i64*)
; CHECK-DAG: [[Sx:%.*]] = load i64, i64* inttoptr (i64 ptrtoint ({{.*}}@__msan_param_tls to i64) to i64*)
...
; CHECK: [[Sa:%.*]] = load [2 x i32], [2 x i32]* inttoptr (i64 ptrtoint ({{.*}}@__msan_param_tls to i64) to [2 x i32]*)
...
; CHECK: [[Ss:%.*]] = load { i32, i32, [3 x i32] }, { i32, i32, [3 x i32] }* inttoptr (i64 ptrtoint ({{.*}}@__msan_param_tls to i64) to { i32, i32, [3 x i32] }*)
...
; CHECK: [[Ss:%.*]] = load [3 x { i32, i32 }], [3 x { i32, i32 }]* inttoptr (i64 ptrtoint ({{.*}}@__msan_param_tls to i64) to [3 x { i32, i32 }]*)
...
; CHECK: [[Ss:%.*]] = load [3 x <8 x i16>], [3 x <8 x i16>]* inttoptr (i64 ptrtoint ({{.*}}@__msan_param_tls to i64) to [3 x <8 x i16>]*)
